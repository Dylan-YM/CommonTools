//
//  HWControlDeviceFanModeAPIManager.m
//  AirTouch
//
...
#import "HWControlDeviceFanModeAPIManager.h"

@interface HWControlDeviceFanModeAPIManager ()

@property (nonatomic, assign) NSInteger deviceId;

@end

@implementation HWControlDeviceFanModeAPIManager

- (NSString *)apiName {
    return [kDeviceControlAPI stringByReplacingOccurrencesOfString:@"{deviceId}" withString:[NSString stringWithFormat:@"%ld", (long)self.deviceId]];
}
